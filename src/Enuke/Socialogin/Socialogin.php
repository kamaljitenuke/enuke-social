 ...
 */
class Socialogin extends BaseFacebook
{
  ...
  public function loginUrl(){
    $params = array(
      'scope' => \Config::get('socialogin::scope'),
      'redirect_uri' => url(\Config::get('socialogin::redirect')),
    );
    return $this->getLoginUrl($params);
  }

  public function logoutUrl(){
    $params = array( 'next' => \Config::get('socialogin::logout'));
